...
if user_input := st.chat_input("Type your message..."):
    ...
    if model_choice == "Web Search":
        try:
            ...
            prompt = f"Query: {user_input}. Search Results: {search_results}. Please frame an appropriate output from this. Make it very informative and engaging with appropriate headings, boldness and linked texts."
