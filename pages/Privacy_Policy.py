...
We are committed to protecting the privacy of our users and strive to provide a transparent experience.
""")

st.write("""
This Privacy Policy outlines how we collect, use, and share information when you use Asti. Please read it carefully.
""")
